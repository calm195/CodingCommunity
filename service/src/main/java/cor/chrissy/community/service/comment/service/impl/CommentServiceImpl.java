...
public class CommentServiceImpl implements CommentService {
    ...
    public Map<Long, CommentTreeDTO> getCommentList(Long articleId, PageSearchReq pageSearchReq) {
        ...
        commentBasicList.forEach(commentDO -> deptTreeMap.put(commentDO.getId(), commentConverter.doToDTO(commentDO)));
    ...
    public void saveComment(CommentReq commentReq) throws Exception {
        if (commentReq.getCommentId() == null || commentReq.getCommentId() == 0) {
            commentMapper.insert(commentConverter.reqToDo(commentReq));
            return;
        }
        ...
        commentMapper.updateById(commentConverter.reqToDo(commentReq));
    }
