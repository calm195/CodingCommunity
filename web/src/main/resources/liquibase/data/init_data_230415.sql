...
INSERT INTO article
(id, author_id, article_type, title, short_title, picture, summary, category_id, source, source_url, official_stat, topping_stat, cream_stat, status, deleted)
...
CREATE TABLE `user_info` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT ''主键ID'',
  `author_id` int(10) unsigned NOT NULL DEFAULT ''0'' COMMENT ''用户ID'',
