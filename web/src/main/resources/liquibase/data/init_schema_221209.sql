...
(
    ...
    `author_id`     int unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='文章标签映射';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='专栏文章列表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='专栏';
...
(
    ...
    `document_id`        int unsigned     NOT NULL DEFAULT '0' COMMENT '文档ID（文章/评论）',
    `document_type`      tinyint          NOT NULL DEFAULT '1' COMMENT '文档类型：1-文章，2-评论',
    `document_author_id` int unsigned     NOT NULL DEFAULT '0' COMMENT '发布该文档的用户ID',
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户个人信息表';
...
(
  ...
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4 COMMENT ='通用数据字典';