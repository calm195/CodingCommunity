...
insert into dict_common(`type_code`,`dict_code`,`dict_desc`,`sort_no`) values('OfficialStat','0','非官方',1);
insert into dict_common(`type_code`,`dict_code`,`dict_desc`,`sort_no`) values('OfficialStat','1','官方',2);
