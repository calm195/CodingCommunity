...
/*!40000 ALTER TABLE `article`
    DISABLE KEYS */;
INSERT INTO `article`
VALUES (3, 1, 1, 'Java小技巧：巧用函数方法实现二维数组遍历', '巧用函数方法实现二维数组遍历', '',
        '对于数组遍历，基本上每个开发者都写过，遍历本身没什么好说的，但是当我们在遍历的过程中，有一些复杂的业务逻辑时，将会发现代码的层级会逐渐加深',
        1, 2, '', 1, 0, '2022-08-06 11:52:13', '2022-08-07 02:11:42'),
       (4, 1, 1, 'SpringBoot系列之xml传参与返回实战演练', 'xml传参与返回实战', '', 'asd', 1, 2, '', 1, 0,
        '2022-08-06 11:55:04', '2022-08-07 03:53:37');
/*!40000 ALTER TABLE `article`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 3, 1, 0, '2022-08-06 11:52:13', '2022-08-06 11:52:13'),
       (9, 4, 1, 0, '2022-08-07 03:52:14', '2022-08-07 03:52:14');
/*!40000 ALTER TABLE `article_tag`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, '后端', 1, 0, '2022-07-20 06:58:20', '2022-07-20 06:58:20'),
       (2, '前端', 1, 0, '2022-07-28 03:35:56', '2022-07-28 03:35:56'),
       (3, '大数据', 1, 0, '2022-07-28 03:36:03', '2022-07-28 03:36:03'),
       (4, 'Android', 1, 0, '2022-07-28 03:36:19', '2022-07-28 03:36:19'),
       (5, 'IOS', 1, 0, '2022-07-28 03:36:24', '2022-07-28 03:37:26'),
       (6, '人工智能', 1, 0, '2022-07-28 03:36:30', '2022-07-28 03:37:26'),
       (7, '开发工具', 1, 0, '2022-07-28 03:36:33', '2022-07-28 03:37:27'),
       (8, '代码人生', 1, 0, '2022-07-28 03:36:37', '2022-07-28 03:37:27'),
       (9, '阅读', 1, 0, '2022-07-28 03:36:40', '2022-07-28 03:37:27');
/*!40000 ALTER TABLE `category`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `tag`
    DISABLE KEYS */;
INSERT INTO `tag`
VALUES (1, 'Java', 1, 1, 0, 0, '2022-07-20 07:03:56', '2022-07-20 07:03:56'),
       (2, 'Go', 1, 1, 0, 0, '2022-07-28 03:38:30', '2022-07-28 03:38:30'),
       (3, 'Python', 1, 1, 0, 0, '2022-07-28 03:38:36', '2022-07-28 03:38:36'),
       (4, 'Spring Boot', 1, 1, 0, 0, '2022-07-28 03:38:48', '2022-07-28 03:38:48'),
       (5, 'Spring', 1, 1, 0, 0, '2022-07-28 03:39:01', '2022-07-28 03:39:01'),
       (6, 'Redis', 1, 1, 0, 0, '2022-07-28 03:39:05', '2022-07-28 03:39:05'),
       (7, 'Linux', 1, 1, 0, 0, '2022-07-28 03:39:10', '2022-07-28 03:39:10'),
       (8, 'JavaScript', 1, 2, 0, 0, '2022-07-28 03:39:37', '2022-07-28 03:39:37'),
       (9, 'React.js', 1, 2, 0, 0, '2022-07-28 03:39:41', '2022-07-28 03:39:41'),
       (10, 'Vue.js', 1, 2, 0, 0, '2022-07-28 03:41:37', '2022-07-28 03:41:37'),
       (11, 'Angular.js', 1, 2, 0, 0, '2022-07-28 03:41:51', '2022-07-28 03:41:51'),
       (12, '小程序', 1, 2, 0, 0, '2022-07-28 03:42:44', '2022-07-28 03:42:44');
/*!40000 ALTER TABLE `tag`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user`
VALUES (1, 'a7cb7228-0f85-4dd5-845c-7c5df3746e92', 0, 0, '2022-08-06 12:45:22', '2022-08-06 12:45:22');
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `document_author_id` int unsigned     NOT NULL COMMENT '发布该文档的用户ID',
...
(
  ...
  AUTO_INCREMENT = 2
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='用户个人信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, 1, '一灰灰', 'https://spring.hhui.top/spring-blog/css/images/avatar.jpg', 'java', 'xm', '码农', '', 0,
        '2022-08-06 12:45:22', '2022-08-06 12:45:22');
/*!40000 ALTER TABLE `user_info`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `follow_stat`    tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '阅读状态: 0-未关注，1-已关注，2-取消关注',
    `create_time`    timestamp           NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_time`    timestamp           NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
    PRIMARY KEY (`id`),
